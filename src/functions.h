...
char check_again(stamp_struct*, double*, float*, float*, float*, double*,
                 double*, int*);
...
void buildStamps(int, int, int, int, int*, int*, int, int, int, stamp_struct*,
                 stamp_struct*, float*, float*, float, float);
...
void makeOutputMask(float*, float, float, float*, float, float, int*, int*,
                    int*);
...
int hp_fits_write_subset(fitsfile*, long, long, long*, float*, int*, int, float,
                         float, int, int, int, int, int, int);
int hp_fits_write_subset_int(fitsfile*, long, long, long*, int*, int*, int,
...
/* mysinc.c */
int swarp_remap(float*, float*, double, double, int, int, int, float*, float*,
                int);
