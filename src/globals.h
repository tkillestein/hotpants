...
EXTERN float tUThresh, tUKThresh, tLThresh, tGain, tRdnoise, iUThresh,
    iUKThresh, iLThresh, iGain, iRdnoise;
EXTERN char *tNoiseIm, *iNoiseIm, *tMaskIm, *iMaskIm, *kernelImIn, *kernelImOut,
    *outMask;
...
#ifdef _OPENMP
#pragma omp threadprivate(rPixX, rPixY, mRData, nS, kerFitThresh, temp, temp2, \
                              wxy, kernel, kernel_coeffs, check_mat,           \
                              check_vec, check_stack)
#endif
